var Yn=Object.defineProperty;var qn=(G,C,R)=>C in G?Yn(G,C,{enumerable:!0,configurable:!0,writable:!0,value:R}):G[C]=R;var h=(G,C,R)=>(qn(G,typeof C!="symbol"?C+"":C,R),R);(function(){"use strict";var G=1e-6,C=typeof Float32Array<"u"?Float32Array:Array;Math.hypot||(Math.hypot=function(){for(var t=0,e=arguments.length;e--;)t+=arguments[e]*arguments[e];return Math.sqrt(t)});function R(){var t=new C(3);return C!=Float32Array&&(t[0]=0,t[1]=0,t[2]=0),t}function B(t,e,o){var c=new C(3);return c[0]=t,c[1]=e,c[2]=o,c}function fn(t,e,o){return t[0]=e[0]+o[0],t[1]=e[1]+o[1],t[2]=e[2]+o[2],t}function ln(t,e,o){return t[0]=e[0]-o[0],t[1]=e[1]-o[1],t[2]=e[2]-o[2],t}function pn(t,e){var o=t[0],c=t[1],s=t[2],p=e[0],f=e[1],r=e[2];return Math.abs(o-p)<=G*Math.max(1,Math.abs(o),Math.abs(p))&&Math.abs(c-f)<=G*Math.max(1,Math.abs(c),Math.abs(f))&&Math.abs(s-r)<=G*Math.max(1,Math.abs(s),Math.abs(r))}var vn=ln;(function(){var t=R();return function(e,o,c,s,p,f){var r,n;for(o||(o=3),c||(c=0),s?n=Math.min(s*o+c,e.length):n=e.length,r=c;r<n;r+=o)t[0]=e[r],t[1]=e[r+1],t[2]=e[r+2],p(t,t,f),e[r]=t[0],e[r+1]=t[1],e[r+2]=t[2];return e}})();var mn=`const OctreeSize = 32u;\r
\r
