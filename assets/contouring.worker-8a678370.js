var kn=Object.defineProperty;var Yn=(G,C,R)=>C in G?kn(G,C,{enumerable:!0,configurable:!0,writable:!0,value:R}):G[C]=R;var z=(G,C,R)=>(Yn(G,typeof C!="symbol"?C+"":C,R),R);(function(){"use strict";var G=1e-6,C=typeof Float32Array<"u"?Float32Array:Array;Math.hypot||(Math.hypot=function(){for(var t=0,e=arguments.length;e--;)t+=arguments[e]*arguments[e];return Math.sqrt(t)});function R(){var t=new C(3);return C!=Float32Array&&(t[0]=0,t[1]=0,t[2]=0),t}function B(t,e,o){var u=new C(3);return u[0]=t,u[1]=e,u[2]=o,u}function fn(t,e,o){return t[0]=e[0]+o[0],t[1]=e[1]+o[1],t[2]=e[2]+o[2],t}function ln(t,e,o){return t[0]=e[0]-o[0],t[1]=e[1]-o[1],t[2]=e[2]-o[2],t}function pn(t,e){var o=t[0],u=t[1],s=t[2],p=e[0],f=e[1],r=e[2];return Math.abs(o-p)<=G*Math.max(1,Math.abs(o),Math.abs(p))&&Math.abs(u-f)<=G*Math.max(1,Math.abs(u),Math.abs(f))&&Math.abs(s-r)<=G*Math.max(1,Math.abs(s),Math.abs(r))}var vn=ln;(function(){var t=R();return function(e,o,u,s,p,f){var r,n;for(o||(o=3),u||(u=0),s?n=Math.min(s*o+u,e.length):n=e.length,r=u;r<n;r+=o)t[0]=e[r],t[1]=e[r+1],t[2]=e[r+2],p(t,t,f),e[r]=t[0],e[r+1]=t[1],e[r+2]=t[2];return e}})();var mn=`const OctreeSize = 32u;\r
\r
...
`;class dn{constructor(e){z(this,"bindGroup");this.bindGroup=e}apply(e){e.setBindGroup(1,this.bindGroup)}}class q{constructor(e){z(this,"augmentationBuffer");z(this,"augmentationArray",[]);z(this,"augmentations");z(this,"onModified",()=>{});this.augmentationBuffer=e,this.augmentations=new ArrayBuffer(Uint32Array.BYTES_PER_ELEMENT*4)}static async init(e){const o=64*Float32Array.BYTES_PER_ELEMENT*8+8,u=e.createBuffer({size:o,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,mappedAtCreation:!1});return new q(u)}async apply(e,o){const u=e.createBindGroup({layout:o.getBindGroupLayout(1),entries:[{binding:0,resource:{buffer:this.augmentationBuffer}}]});return new dn(u)}modify(e,o){this.augmentationArray.push(o),this.update(e,this.augmentationArray),this.onModified()}update(e,o){this.augmentations=new ArrayBuffer(Uint32Array.BYTES_PER_ELEMENT*4+Uint32Array.BYTES_PER_ELEMENT*o.length*8);const u=new Uint32Array(this.augmentations,0,4);u[0]=o.length;const s=new Float32Array(this.augmentations,Uint32Array.BYTES_PER_ELEMENT*4),p=new Uint32Array(this.augmentations,Uint32Array.BYTES_PER_ELEMENT*4);for(let f=0;f<o.length;f++)s[f*8]=o[f].x,s[f*8+1]=o[f].y,s[f*8+2]=o[f].z,s[f*8+3]=o[f].size,p[f*8+4]=o[f].type|o[f].shape<<1|o[f].material<<8;e.queue.writeBuffer(this.augmentationBuffer,0,this.augmentations,0,this.augmentations.byteLength)}updateRaw(e,o){this.augmentations=o,e.queue.writeBuffer(this.augmentationBuffer,0,this.augmentations,0,this.augmentations.byteLength)}static patch(e){return e.replace("#import density",gn)}}var N=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function zn(t){if(t.__esModule)return t;var e=t.default;if(typeof e=="function"){var o=function u(){if(this instanceof u){var s=[null];s.push.apply(s,arguments);var p=Function.bind.apply(e,s);return new p}return e.apply(this,arguments)};o.prototype=e.prototype}else o={};return Object.defineProperty(o,"__esModule",{value:!0}),Object.keys(t).forEach(function(u){var s=Object.getOwnPropertyDescriptor(t,u);Object.defineProperty(o,u,s.get?s:{enumerable:!0,get:function(){return t[u]}})}),o}var V={},hn={get exports(){return V},set exports(t){V=t}};(function(t){(function(e,o,u){function s(n){var i=this,l=r();i.next=function(){var a=2091639*i.s0+i.c*23283064365386963e-26;return i.s0=i.s1,i.s1=i.s2,i.s2=a-(i.c=a|0)},i.c=1,i.s0=l(" "),i.s1=l(" "),i.s2=l(" "),i.s0-=l(n),i.s0<0&&(i.s0+=1),i.s1-=l(n),i.s1<0&&(i.s1+=1),i.s2-=l(n),i.s2<0&&(i.s2+=1),l=null}function p(n,i){return i.c=n.c,i.s0=n.s0,i.s1=n.s1,i.s2=n.s2,i}function f(n,i){var l=new s(n),a=i&&i.state,c=l.next;return c.int32=function(){return l.next()*4294967296|0},c.double=function(){return c()+(c()*2097152|0)*11102230246251565e-32},c.quick=c,a&&(typeof a=="object"&&p(a,l),c.state=function(){return p(l,{})}),c}function r(){var n=4022871197,i=function(l){l=String(l);for(var a=0;a<l.length;a++){n+=l.charCodeAt(a);var c=.02519603282416938*n;n=c>>>0,c-=n,c*=n,n=c>>>0,c-=n,n+=c*4294967296}return(n>>>0)*23283064365386963e-26};return i}o&&o.exports?o.exports=f:u&&u.amd?u(function(){return f}):this.alea=f})(N,t,!1)})(hn);var X={},Pn={get exports(){return X},set exports(t){X=t}};(function(t){(function(e,o,u){function s(r){var n=this,i="";n.x=0,n.y=0,n.z=0,n.w=0,n.next=function(){var a=n.x^n.x<<11;return n.x=n.y,n.y=n.z,n.z=n.w,n.w^=n.w>>>19^a^a>>>8},r===(r|0)?n.x=r:i+=r;for(var l=0;l<i.length+64;l++)n.x^=i.charCodeAt(l)|0,n.next()}function p(r,n){return n.x=r.x,n.y=r.y,n.z=r.z,n.w=r.w,n}function f(r,n){var i=new s(r),l=n&&n.state,a=function(){return(i.next()>>>0)/4294967296};return a.double=function(){do var c=i.next()>>>11,v=(i.next()>>>0)/4294967296,m=(c+v)/(1<<21);while(m===0);return m},a.int32=i.next,a.quick=a,l&&(typeof l=="object"&&p(l,i),a.state=function(){return p(i,{})}),a}o&&o.exports?o.exports=f:u&&u.amd?u(function(){return f}):this.xor128=f})(N,t,!1)})(Pn);var H={},bn={get exports(){return H},set exports(t){H=t}};(function(t){(function(e,o,u){function s(r){var n=this,i="";n.next=function(){var a=n.x^n.x>>>2;return n.x=n.y,n.y=n.z,n.z=n.w,n.w=n.v,(n.d=n.d+362437|0)+(n.v=n.v^n.v<<4^(a^a<<1))|0},n.x=0,n.y=0,n.z=0,n.w=0,n.v=0,r===(r|0)?n.x=r:i+=r;for(var l=0;l<i.length+64;l++)n.x^=i.charCodeAt(l)|0,l==i.length&&(n.d=n.x<<10^n.x>>>4),n.next()}function p(r,n){return n.x=r.x,n.y=r.y,n.z=r.z,n.w=r.w,n.v=r.v,n.d=r.d,n}function f(r,n){var i=new s(r),l=n&&n.state,a=function(){return(i.next()>>>0)/4294967296};return a.double=function(){do var c=i.next()>>>11,v=(i.next()>>>0)/4294967296,m=(c+v)/(1<<21);while(m===0);return m},a.int32=i.next,a.quick=a,l&&(typeof l=="object"&&p(l,i),a.state=function(){return p(i,{})}),a}o&&o.exports?o.exports=f:u&&u.amd?u(function(){return f}):this.xorwow=f})(N,t,!1)})(bn);var $={},_n={get exports(){return $},set exports(t){$=t}};(function(t){(function(e,o,u){function s(r){var n=this;n.next=function(){var l=n.x,a=n.i,c,v;return c=l[a],c^=c>>>7,v=c^c<<24,c=l[a+1&7],v^=c^c>>>10,c=l[a+3&7],v^=c^c>>>3,c=l[a+4&7],v^=c^c<<7,c=l[a+7&7],c=c^c<<13,v^=c^c<<9,l[a]=v,n.i=a+1&7,v};function i(l,a){var c,v=[];if(a===(a|0))v[0]=a;else for(a=""+a,c=0;c<a.length;++c)v[c&7]=v[c&7]<<15^a.charCodeAt(c)+v[c+1&7]<<13;for(;v.length<8;)v.push(0);for(c=0;c<8&&v[c]===0;++c);for(c==8?v[7]=-1:v[c],l.x=v,l.i=0,c=256;c>0;--c)l.next()}i(n,r)}function p(r,n){return n.x=r.x.slice(),n.i=r.i,n}function f(r,n){r==null&&(r=+new Date);var i=new s(r),l=n&&n.state,a=function(){return(i.next()>>>0)/4294967296};return a.double=function(){do var c=i.next()>>>11,v=(i.next()>>>0)/4294967296,m=(c+v)/(1<<21);while(m===0);return m},a.int32=i.next,a.quick=a,l&&(l.x&&p(l,i),a.state=function(){return p(i,{})}),a}o&&o.exports?o.exports=f:u&&u.amd?u(function(){return f}):this.xorshift7=f})(N,t,!1)})(_n);var Z={},An={get exports(){return Z},set exports(t){Z=t}};(function(t){(function(e,o,u){function s(r){var n=this;n.next=function(){var l=n.w,a=n.X,c=n.i,v,m;return n.w=l=l+1640531527|0,m=a[c+34&127],v=a[c=c+1&127],m^=m<<13,v^=v<<17,m^=m>>>15,v^=v>>>12,m=a[c]=m^v,n.i=c,m+(l^l>>>16)|0};function i(l,a){var c,v,m,g,_,d=[],I=128;for(a===(a|0)?(v=a,a=null):(a=a+"\0",v=0,I=Math.max(I,a.length)),m=0,g=-32;g<I;++g)a&&(v^=a.charCodeAt((g+32)%a.length)),g===0&&(_=v),v^=v<<10,v^=v>>>15,v^=v<<4,v^=v>>>13,g>=0&&(_=_+1640531527|0,c=d[g&127]^=v+_,m=c==0?m+1:0);for(m>=128&&(d[(a&&a.length||0)&127]=-1),m=127,g=4*128;g>0;--g)v=d[m+34&127],c=d[m=m+1&127],v^=v<<13,c^=c<<17,v^=v>>>15,c^=c>>>12,d[m]=v^c;l.w=_,l.X=d,l.i=m}i(n,r)}function p(r,n){return n.i=r.i,n.w=r.w,n.X=r.X.slice(),n}function f(r,n){r==null&&(r=+new Date);var i=new s(r),l=n&&n.state,a=function(){return(i.next()>>>0)/4294967296};return a.double=function(){do var c=i.next()>>>11,v=(i.next()>>>0)/4294967296,m=(c+v)/(1<<21);while(m===0);return m},a.int32=i.next,a.quick=a,l&&(l.X&&p(l,i),a.state=function(){return p(i,{})}),a}o&&o.exports?o.exports=f:u&&u.amd?u(function(){return f}):this.xor4096=f})(N,t,!1)})(An);var W={},wn={get exports(){return W},set exports(t){W=t}};(function(t){(function(e,o,u){function s(r){var n=this,i="";n.next=function(){var a=n.b,c=n.c,v=n.d,m=n.a;return a=a<<25^a>>>7^c,c=c-v|0,v=v<<24^v>>>8^m,m=m-a|0,n.b=a=a<<20^a>>>12^c,n.c=c=c-v|0,n.d=v<<16^c>>>16^m,n.a=m-a|0},n.a=0,n.b=0,n.c=-1640531527,n.d=1367130551,r===Math.floor(r)?(n.a=r/4294967296|0,n.b=r|0):i+=r;for(var l=0;l<i.length+20;l++)n.b^=i.charCodeAt(l)|0,n.next()}function p(r,n){return n.a=r.a,n.b=r.b,n.c=r.c,n.d=r.d,n}function f(r,n){var i=new s(r),l=n&&n.state,a=function(){return(i.next()>>>0)/4294967296};return a.double=function(){do var c=i.next()>>>11,v=(i.next()>>>0)/4294967296,m=(c+v)/(1<<21);while(m===0);return m},a.int32=i.next,a.quick=a,l&&(typeof l=="object"&&p(l,i),a.state=function(){return p(i,{})}),a}o&&o.exports?o.exports=f:u&&u.amd?u(function(){return f}):this.tychei=f})(N,t,!1)})(wn);var K={},En={get exports(){return K},set exports(t){K=t}},Bn={},Mn=Object.freeze({__proto__:null,default:Bn}),Sn=zn(Mn);(function(t){(function(e,o,u){var s=256,p=6,f=52,r="random",n=u.pow(s,p),i=u.pow(2,f),l=i*2,a=s-1,c;function v(x,y,b){var h=[];y=y==!0?{entropy:!0}:y||{};var P=d(_(y.entropy?[x,M(o)]:x??I(),3),h),E=new m(h),w=function(){for(var S=E.g(p),T=n,A=0;S<i;)S=(S+A)*s,T*=s,A=E.g(1);for(;S>=l;)S/=2,T/=2,A>>>=1;return(S+A)/T};return w.int32=function(){return E.g(4)|0},w.quick=function(){return E.g(4)/4294967296},w.double=w,d(M(E.S),o),(y.pass||b||function(S,T,A,D){return D&&(D.S&&g(D,E),S.state=function(){return g(E,{})}),A?(u[r]=S,T):S})(w,P,"global"in y?y.global:this==u,y.state)}function m(x){var y,b=x.length,h=this,P=0,E=h.i=h.j=0,w=h.S=[];for(b||(x=[b++]);P<s;)w[P]=P++;for(P=0;P<s;P++)w[P]=w[E=a&E+x[P%b]+(y=w[P])],w[E]=y;(h.g=function(S){for(var T,A=0,D=h.i,j=h.j,Y=h.S;S--;)T=Y[D=a&D+1],A=A*s+Y[a&(Y[D]=Y[j=a&j+T])+(Y[j]=T)];return h.i=D,h.j=j,A})(s)}function g(x,y){return y.i=x.i,y.j=x.j,y.S=x.S.slice(),y}function _(x,y){var b=[],h=typeof x,P;if(y&&h=="object")for(P in x)try{b.push(_(x[P],y-1))}catch{}return b.length?b:h=="string"?x:x+"\0"}function d(x,y){for(var b=x+"",h,P=0;P<b.length;)y[a&P]=a&(h^=y[a&P]*19)+b.charCodeAt(P++);return M(y)}function I(){try{var x;return c&&(x=c.randomBytes)?x=x(s):(x=new Uint8Array(s),(e.crypto||e.msCrypto).getRandomValues(x)),M(x)}catch{var y=e.navigator,b=y&&y.plugins;return[+new Date,e,b,e.screen,M(o)]}}function M(x){return String.fromCharCode.apply(0,x)}if(d(u.random(),o),t.exports){t.exports=v;try{c=Sn}catch{}}else u["seed"+r]=v})(typeof self<"u"?self:N,[],Math)})(En);var In=V,Cn=X,Tn=H,Gn=$,Rn=Z,Un=W,L=K;L.alea=In,L.xor128=Cn,L.xorwow=Tn,L.xorshift7=Gn,L.xor4096=Rn,L.tychei=Un;var rn=L;const O=0,J=[[0,4,0],[1,5,0],[2,6,0],[3,7,0],[0,2,1],[4,6,1],[1,3,1],[5,7,1],[0,1,2],[2,3,2],[4,5,2],[6,7,2]],F=[[0,1,2,3,0],[4,5,6,7,0],[0,4,1,5,1],[2,6,3,7,1],[0,2,4,6,2],[1,3,5,7,2]],Q=[[[4,0,0],[5,1,0],[6,2,0],[7,3,0]],[[2,0,1],[6,4,1],[3,1,1],[7,5,1]],[[1,0,2],[3,2,2],[5,4,2],[7,6,2]]],U=[[[1,4,0,5,1,1],[1,6,2,7,3,1],[0,4,6,0,2,2],[0,5,7,1,3,2]],[[0,2,3,0,1,0],[0,6,7,4,5,0],[1,2,0,6,4,2],[1,3,1,7,5,2]],[[1,1,0,3,2,0],[1,5,4,7,6,0],[0,1,5,0,4,1],[0,3,7,2,6,1]]],k=[[[3,2,1,0,0],[7,6,5,4,0]],[[5,1,4,0,1],[7,3,6,2,1]],[[6,4,2,0,2],[7,5,3,1,2]]],Dn=[[3,2,1,0],[7,5,6,4],[11,10,9,8]],on=[[0,4],[1,5],[2,6],[3,7],[0,2],[1,3],[4,6],[5,7],[0,1],[2,3],[4,5],[6,7]],Nn=(t,e,o)=>{let u=1e6,s=0;const p=[-1,-1,-1,-1];let f=!1;const r=[!1,!1,!1,!1];for(let n=0;n<4;n++){const i=Dn[e][n],l=on[i][0],a=on[i][1],c=t[n].drawInfo.corners>>l&1,v=t[n].drawInfo.corners>>a&1;t[n].size<u&&(u=t[n].size,s=n,f=c!==O),p[n]=t[n].drawInfo.index,r[n]=c===O&&v!==O||c!==O&&v===O}r[s]&&(f?(o.push(p[0]),o.push(p[3]),o.push(p[1]),o.push(p[0]),o.push(p[2]),o.push(p[3])):(o.push(p[0]),o.push(p[1]),o.push(p[3]),o.push(p[0]),o.push(p[3]),o.push(p[2])))},nn=(t,e,o)=>{if(!(t[0]==null||t[1]==null||t[2]==null||t[3]==null))if(t[0].type!=="internal"&&t[1].type!=="internal"&&t[2].type!=="internal"&&t[3].type!=="internal")Nn(t,e,o);else for(let u=0;u<2;u++){const s=[],p=[k[e][u][0],k[e][u][1],k[e][u][2],k[e][u][3]];for(let f=0;f<4;f++)t[f].type==="leaf"||t[f].type==="pseudo"?s[f]=t[f]:s[f]=t[f].children[p[f]];nn(s,k[e][u][4],o)}},an=(t,e,o)=>{if(!(t[0]==null||t[1]==null)&&(t[0].type==="internal"||t[1].type==="internal")){for(let s=0;s<4;s++){const p=[],f=[Q[e][s][0],Q[e][s][1]];for(let r=0;r<2;r++)t[r].type!=="internal"?p[r]=t[r]:p[r]=t[r].children[f[r]];an(p,Q[e][s][2],o)}const u=[[0,0,1,1],[0,1,0,1]];for(let s=0;s<4;s++){const p=[],f=[U[e][s][1],U[e][s][2],U[e][s][3],U[e][s][4]],r=[u[U[e][s][0]][0],u[U[e][s][0]][1],u[U[e][s][0]][2],u[U[e][s][0]][3]];for(let n=0;n<4;n++)t[r[n]].type==="leaf"||t[r[n]].type==="pseudo"?p[n]=t[r[n]]:p[n]=t[r[n]].children[f[n]];nn(p,U[e][s][5],o)}}},sn=(t,e)=>{if(t!=null&&t.type==="internal"){for(let o=0;o<8;o++)sn(t.children[o],e);for(let o=0;o<12;o++){const u=[],s=[J[o][0],J[o][1]];u[0]=t.children[s[0]],u[1]=t.children[s[1]],an(u,J[o][2],e)}for(let o=0;o<6;o++){const u=[],s=[F[o][0],F[o][1],F[o][2],F[o][3]];for(let p=0;p<4;p++)u[p]=t.children[s[p]];nn(u,F[o][4],e)}}},tn=[B(0,0,0),B(0,0,1),B(0,1,0),B(0,1,1),B(1,0,0),B(1,0,1),B(1,1,0),B(1,1,1)],un=(t,e,o)=>{const u=new Map;for(let s=0;s<t.length;s++){const p=t[s],f=vn(R(),p.min,B((p.min[0]-e[0])%o,(p.min[1]-e[1])%o,(p.min[2]-e[2])%o));let r=u[`${f[0]},${f[1]},${f[2]}`];r||(r={min:f,size:o,type:"internal",children:[]},u[`${r.min[0]},${r.min[1]},${r.min[2]}`]=r);for(let n=0;n<8;n++){const i=fn(R(),f,B(tn[n][0]*p.size,tn[n][1]*p.size,tn[n][2]*p.size));if(pn(i,p.min)){r.children[n]=p;break}}}return t.length=0,Object.values(u)},Ln=(t,e,o)=>{if(t.length==0)return null;for(t.sort((s,p)=>s.size-p.size);t[0].size!=t[t.length-1].size;){let s=0;const p=t[s].size;do++s;while(t[s].size==p);let f=[];for(let r=0;r<s;r++)f.push(t[r]);f=un(f,e,p*2);for(let r=s;r<t.Count;r++)f.push(t[r]);t.length=0;for(let r=0;r<f.length;r++)t.push(f[r])}let u=t[0].size*2;for(;u<=o;)t=un(t,e,u),u*=2;return t.length!=1?(console.log(t),console.error("There can only be one root node!"),null):t[0]},cn=(t,e,o,u)=>{if(t!=null){if(t.size>u&&t.type!=="leaf")for(let s=0;s<8;s++)cn(t.children[s],e,o,u);if(t.type!=="internal"){const s=t.drawInfo;if(s==null)throw"Error! Could not add vertex!";s.index=e.length/3,e.push(s.position[0],s.position[1],s.position[2]),o.push(s.averageNormal[0],s.averageNormal[1],s.averageNormal[2])}}},On=(t,e,o,u)=>{const s=[];if(o===0)return{vertices:new Float32Array,normals:new Float32Array,indices:new Uint16Array,corners:new Uint32Array};for(let i=0;i<o*12;i+=12)if(u[i+11]!==0){const l={type:"leaf",size:e,min:B(u[i],u[i+1],u[i+2]),drawInfo:{position:B(u[i+4],u[i+5],u[i+6]),averageNormal:B(u[i+8],u[i+9],u[i+10]),corners:u[i+3]}};s.push(l)}const p=Ln(s,t,32*e),f=[],r=[];cn(p,f,r,1);const n=[];return sn(p,n),{vertices:new Float32Array(f),normals:new Float32Array(r),indices:new Uint16Array(n),corners:new Uint32Array}};class en{constructor(e,o,u,s,p,f,r,n,i,l,a,c,v,m,g,_,d,I,M,x,y){z(this,"running",!1);z(this,"computePipeline");z(this,"computeCornersPipeline");z(this,"uniformBuffer");z(this,"cornerMaterials");z(this,"cornerMaterialsRead");z(this,"voxelMaterialsBuffer");z(this,"voxelMaterialsBufferRead");z(this,"cornerIndexBuffer");z(this,"gpuReadBuffer");z(this,"permutationsBuffer");z(this,"voxelsBuffer");z(this,"computeBindGroup");z(this,"computeCornersBindGroup");z(this,"computePositionsPipeline");z(this,"computePositionsBindGroup");z(this,"computeVoxelsPipeline");z(this,"computeVoxelsBindGroup");z(this,"voxelReadBuffer");z(this,"density");z(this,"densityBindGroup");z(this,"mainDensityBindGroup");this.computePipeline=e,this.computeCornersPipeline=o,this.uniformBuffer=u,this.cornerMaterials=s,this.cornerMaterialsRead=p,this.voxelMaterialsBuffer=f,this.voxelMaterialsBufferRead=r,this.cornerIndexBuffer=n,this.gpuReadBuffer=i,this.permutationsBuffer=l,this.voxelsBuffer=a,this.computeBindGroup=c,this.computeCornersBindGroup=v,this.computePositionsPipeline=m,this.computePositionsBindGroup=g,this.computeVoxelsPipeline=_,this.computeVoxelsBindGroup=d,this.voxelReadBuffer=I,this.density=M,this.densityBindGroup=x,this.mainDensityBindGroup=y}static async init(e){const o=q.patch(yn),u=performance.now();console.log("Start loading voxel engine",performance.now()-u);const s=e.createShaderModule({code:o}),p=await e.createComputePipelineAsync({layout:"auto",compute:{module:s,entryPoint:"computeMaterials"}}),f=await e.createComputePipelineAsync({layout:"auto",compute:{module:e.createShaderModule({code:mn}),entryPoint:"main"}}),r=Math.max(4*5,32),n=e.createBuffer({size:r,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),i=e.createBuffer({size:Uint32Array.BYTES_PER_ELEMENT*33*33*33,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC,mappedAtCreation:!1}),l=e.createBuffer({size:Uint32Array.BYTES_PER_ELEMENT*33*33*33,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),a=e.createBuffer({size:Uint32Array.BYTES_PER_ELEMENT*32*32*32,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC,mappedAtCreation:!1}),c=e.createBuffer({size:Uint32Array.BYTES_PER_ELEMENT*32*32*32,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),v=e.createBuffer({size:Uint32Array.BYTES_PER_ELEMENT+Uint32Array.BYTES_PER_ELEMENT*32*32*32,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC,mappedAtCreation:!1}),m=e.createBuffer({size:Uint32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),g=new Int32Array(512),_=new rn(6452);for(let A=0;A<256;A++)g[A]=256*_();for(let A=256;A<512;A++)g[A]=g[A-256];const d=e.createBuffer({size:g.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,mappedAtCreation:!0});new Int32Array(d.getMappedRange()).set(g),d.unmap();const I=e.createBuffer({size:Float32Array.BYTES_PER_ELEMENT*12*32*32*32,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC,mappedAtCreation:!1}),M=e.createBindGroup({layout:p.getBindGroupLayout(0),entries:[{binding:1,resource:{buffer:i}},{binding:5,resource:{buffer:n}}]}),x=e.createBindGroup({layout:f.getBindGroupLayout(0),entries:[{binding:1,resource:{buffer:i}},{binding:2,resource:{buffer:a}}]}),y=await e.createComputePipelineAsync({layout:"auto",compute:{module:e.createShaderModule({code:xn}),entryPoint:"main"}}),b=e.createBindGroup({layout:y.getBindGroupLayout(0),entries:[{binding:2,resource:{buffer:a}},{binding:3,resource:{buffer:v}}]}),h=await e.createComputePipelineAsync({layout:"auto",compute:{module:s,entryPoint:"main"}}),P=e.createBindGroup({layout:h.getBindGroupLayout(0),entries:[{binding:2,resource:{buffer:a}},{binding:3,resource:{buffer:v}},{binding:4,resource:{buffer:I}},{binding:5,resource:{buffer:n}}]}),E=e.createBuffer({size:Float32Array.BYTES_PER_ELEMENT*12*32*32*32,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),w=await q.init(e),S=await w.apply(e,p),T=await w.apply(e,h);return console.log("Done",performance.now()-u),new en(p,f,n,i,l,a,c,v,m,d,I,M,x,y,b,h,P,E,w,S,T)}generate(e,o,u,s,p){return s||(s=1),new Promise(f=>{this.density.updateRaw(e,p);const r=new Int32Array(512),n=new rn("James");for(let d=0;d<256;d++)r[d]=256*n();for(let d=256;d<512;d++)r[d]=r[d-256];e.queue.writeBuffer(this.permutationsBuffer,0,r.buffer,r.byteOffset,r.byteLength);const i=new ArrayBuffer(4*5),l=new Float32Array(i,0,4);l.set(u,0),l[3]=s,new Uint32Array(i,16,1)[0]=33,e.queue.writeBuffer(this.uniformBuffer,0,i,0,i.byteLength);const a=e.createCommandEncoder(),c=32,v=a.beginComputePass();v.setPipeline(this.computePipeline),v.setBindGroup(0,this.computeBindGroup),this.densityBindGroup.apply(v),v.dispatchWorkgroups(c+1,c+1,c+1),v.end();const m=a.beginComputePass();m.setPipeline(this.computeCornersPipeline),m.setBindGroup(0,this.computeCornersBindGroup),m.dispatchWorkgroups(c,c,c),m.end();const g=a.beginComputePass();g.setPipeline(this.computePositionsPipeline),g.setBindGroup(0,this.computePositionsBindGroup),g.dispatchWorkgroups(1),g.end();const _=e.createCommandEncoder();_.copyBufferToBuffer(this.cornerIndexBuffer,0,this.gpuReadBuffer,0,Uint32Array.BYTES_PER_ELEMENT),_.copyBufferToBuffer(this.cornerMaterials,0,this.cornerMaterialsRead,0,Uint32Array.BYTES_PER_ELEMENT*33*33*33),_.copyBufferToBuffer(this.voxelMaterialsBuffer,0,this.voxelMaterialsBufferRead,0,Uint32Array.BYTES_PER_ELEMENT*32*32*32),o({items:[a.finish(),_.finish()],callback:async()=>{await this.cornerMaterialsRead.mapAsync(GPUMapMode.READ);const d=new Uint32Array(this.cornerMaterialsRead.getMappedRange()).slice();this.cornerMaterialsRead.unmap(),await this.gpuReadBuffer.mapAsync(GPUMapMode.READ);const I=this.gpuReadBuffer.getMappedRange(),M=new Uint32Array(I)[0];if(this.gpuReadBuffer.unmap(),M===0){f({vertices:new Float32Array,normals:new Float32Array,indices:new Uint16Array,corners:d,consistency:d[0]});return}const x=Math.ceil(M/128),y=e.createCommandEncoder(),b=y.beginComputePass();b.setPipeline(this.computeVoxelsPipeline),b.setBindGroup(0,this.computeVoxelsBindGroup),this.mainDensityBindGroup.apply(b),b.dispatchWorkgroups(x),b.end();const h=e.createCommandEncoder();h.copyBufferToBuffer(this.voxelsBuffer,0,this.voxelReadBuffer,0,Float32Array.BYTES_PER_ELEMENT*M*12),o({items:[y.finish(),h.finish()],callback:async()=>{await this.voxelReadBuffer.mapAsync(GPUMapMode.READ);const P=this.voxelReadBuffer.getMappedRange(),E=new Float32Array(P),w=On(u,s,M,E);this.voxelReadBuffer.unmap(),f({...w,corners:d,consistency:-1})}})}})})}}const Fn=self;(async function(){const t=await navigator.gpu.requestAdapter();if(!t)throw new Error("Unable to acquire GPU adapter, is WebGPU enabled?");const e=await t.requestDevice(),o=await en.init(e);console.log("Voxel engine init complete"),postMessage({type:"init_complete"});const u=s=>{e.queue.onSubmittedWorkDone().then(s.callback),e.queue.submit(s.items)};onmessage=async function(s){const{detail:p,density:f}=s.data,r=31,{x:n,y:i,z:l,s:a}=p,c=a*r*.5,{vertices:v,normals:m,indices:g,consistency:_}=await o.generate(e,u,B(n*r-c,i*r-c,l*r-c),a,f);Fn.postMessage({type:"update",i:`${n}:${i}:${l}`,ix:n,iy:i,iz:l,x:0,y:0,z:0,vertices:v.buffer,normals:m.buffer,indices:g.buffer,stride:a,consistency:_},[v.buffer,m.buffer,g.buffer])}})()})();
